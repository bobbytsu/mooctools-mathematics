            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay +1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 7}}s">{{$case_4_input_1_digit_1}}</span>
                        <span class="color-animation" style="animation-delay: {{$delay + 2}}s">{{$case_4_input_1_digit_2}}</span>
                    </h5>
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 9}}s">{{$case_4_input_2_digit_1}}</span>
                        ...
                        <span class="color-animation" style="animation-delay: {{$delay + 3}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 8}}s">
                                +
                            </span>
                        </span>
                    </h5>
                    ...
                    <h5 class="mt-2 result-2-digit">
                        <span class="drop-in" style="animation-delay: {{$delay + 11}}s">{{$result_digit_1}}</span>
