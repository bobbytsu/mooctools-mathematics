...
<head>
    ...
    <title>Quiz 3rd & 4th Grade Result</title>
...
<body>
    ...
    <div class="container my-5 bg-light">
        <div class="p-5">
            ...
            <h4 class="text-center my-5">Quiz Result: 3<sup>rd</sup> & 4<sup>th</sup> Grade</h4>
            <h5 class="mb-5">Question</h5>
            <div class="form-group row d-flex align-items-center">
                <label for="question1" class="col-auto col-form-label">
                    <h5>1.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ session('question1') }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=</h5>
                </label>
                <div class="col-auto">
