            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-xl-5 m-sm-2">
                    ...
                    @if($calculation3 != 0)
                        ...
                        <h5 class="drop-in division-add-zero-1 text-primary" style="animation-delay: {{$delay + 39}}s">
                        ...
                        @if($calculation7 != 0)
                            ...
                            <h5 class="drop-in division-add-zero-2 text-primary" style="animation-delay: {{$delay + 91}}s">
                            ...
                            @if($calculation11 != 0)
                                ...
                                <h5 class="drop-in division-add-zero-3 text-primary" style="animation-delay: {{$delay + 135}}s">
