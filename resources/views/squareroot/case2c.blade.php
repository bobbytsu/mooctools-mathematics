            ...
            <div class="bg-white border p-4">
                ...
                <div class="my-5 mx-xl-5 mx-lg-5 mx-md-5 mx-sm-5 mx-xs-5 mx-0">
                    ...
                    <h5 class="squareroot-nearest-sqrt-1">
                        ...
                        <span class="drop-in" style="animation-delay: {{$delay + 78}}s">
                            .
                        </span>
                    ...
                    <h5 class="drop-in squareroot-calculation1-format" style="animation-delay: {{$delay + 38}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 53}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 86}}s">
                    ...
                    <h5 class="squareroot-calculation6 drop-in" style="animation-delay: {{$delay + 83}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 88}}s">
                            {{$calculation6}}
                        </span>
                        &nbsp;
                        <span class="drop-in" style="animation-delay: {{$delay + 85}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 87}}s">
                                -
                            </span>
                        </span>
                    </h5>
                    <hr class="drop-in squareroot-hr" style="animation-delay: {{$delay + 85}}s">
                    <h5 class="squareroot-calculation4-arrow drop-out" style="animation-delay: {{$delay + 69}}s">
                    ...
                    <h5 class="squareroot-calculation4-arrow-1 drop-in" style="animation-delay: {{$delay + 74}}s">
                        <span class="drop-out" style="animation-delay: {{$delay + 84}}s">
                            <span>→</span>
                            <span>
                                {{$calculation2}}
                            </span>
                            <span class="color-animation" style="margin-left: -5px; animation-delay: {{$delay + 76}}s">
                                .{{$calculation4}}
                            </span>
                            <span>x</span>
                            <span class="color-animation" style="animation-delay: {{$delay + 76}}s">
                                {{$calculation5}}
                            </span>
                            <span>
                                =
                    ...
                    @for ($j = 0; $j < $count; $j++)
                        @if ($j < 2 || ($j === $count - 1 && $calculations[$j] <= $calculation1))
                            <h5 class="drop-in squareroot-calculation4-arrow-2" style="animation-delay: {{$delay + 60 + $k}}s">
                                <span class="drop-out" style="animation-delay: {{$delay + 69 + $k}}s">
                    ...
                    <h5 class="drop-in squareroot-case2c-calculation7" style="animation-delay: {{$delay + 25}}s">
                        {{$calculation7}}
                    </h5>                    
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 26}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 27}}s"><b>{{floor(sqrt($input) * 10) / 10}}</b></h5>
            </div>
        </div>
    </div>
    <!-- Content -->
