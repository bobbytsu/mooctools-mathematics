            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    ...
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay + 13}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 26}}s">{{$case_3_input_2_digit_1}}</span>
                    ...
                    <h5 class="mt-2 result-3-digit">
                        <span class="drop-in" style="animation-delay: {{$delay + 28}}s">{{$result_digit_1}}</span>
                ...
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 29}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 30}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
