...
<head>
    ...
    <title>Quiz 1st & 2nd Grade</title>
...
<body>
    ...
    <div class="container my-5 bg-light">
        <div class="p-5">
            ...
            <h4 class="text-center my-5">Quiz: 1<sup>st</sup> & 2<sup>nd</sup> Grade</h4>
            <h5 class="mb-5">Question</h5>
            <form method="POST" action="{{ route('quiz1st2ndgraderesult') }}" onsubmit="return confirm('Are you sure want to submit these answers?')">
                @csrf
                @php
                    $i = 1;
                @endphp
