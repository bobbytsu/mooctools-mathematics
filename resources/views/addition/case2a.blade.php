            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 7}}s">{{$case_2_input_1_digit_1}}</span>
                        <span class="color-animation" style="animation-delay: {{$delay + 2}}s">{{$case_2_input_1_digit_2}}</span>
                    </h5>
                    <h5 class="ml-case-2-a-b-input-2 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 4}}s">{{$case_2_input_2_digit_1}}</span>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="color-animation" style="animation-delay: {{$delay + 3}}s">+</span>
                    </h5>
                    <hr class="drop-in" style="animation-delay: {{$delay + 1}}s">
                    <h5 class="mt-2 ml-5">
                        <span class="drop-in" style="animation-delay: {{$delay + 9}}s">{{$result_digit_1}}</span>
                        <span class="drop-in" style="animation-delay: {{$delay + 6}}s">{{$result_digit_2}}</span>
                    </h5>
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 10}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 11}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
