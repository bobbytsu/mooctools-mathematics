    ...
    <div class="container my-5 bg-light">
        <div class="p-5">
            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    <h5 class="borrowed-new-value drop-in" style="animation-delay: {{$delay + 18}}s">
                        <span class="move-text-3" style="animation-delay: {{$delay + 30}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 34}}s">
                                {{$borrowed}}
                            </span>
                        </span>
                    </h5>
                    <h5 class="borrow-new-value drop-in" style="animation-delay: {{$delay + 21}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 24}}s">
                            {{$borrow}}
                        </span>
                    </h5>
                    <h5 class="borrowed drop-in" style="animation-delay: {{$delay + 16}}s">
                        <span class="text-danger drop-out" style="animation-delay: {{$delay + 19}}s">
                            - 1
                        </span>
                    </h5>
                    <h5 class="borrow drop-in" style="animation-delay: {{$delay + 16}}s">
                        <span class="text-success drop-out" style="animation-delay: {{$delay + 22}}s">
                            + 10
                        </span>
                    </h5>
                    <h5 class="x drop-in text-danger" style="animation-delay: {{$delay + 6}}s">
                        <span class="drop-out" style="animation-delay: {{$delay + 8}}s">
                            X
                        </span>
                    </h5>
                    <h5 class="drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="move-text-2" style="animation-delay: {{$delay + 12}}s">
                    ...
                    <h5 class="ml-case-2-c-input-2 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 2}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 9}}s">
                                <span class="drop-out" style="animation-delay: {{$delay + 21}}s">
                                    {{$case_3_input_1_digit_2}}
                                </span>
                            </span>
                        </span>
                    </h5>
                    <h5 class="subtraction-input-2-digit-1 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="mr-1 color-animation" style="animation-delay: {{$delay + 36}}s">
                            {{$case_3_input_2_digit_1}}
                        </span>
                        <span class="color-animation" style="animation-delay: {{$delay + 4}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 26}}s">
                                {{$case_3_input_2_digit_2}}
                            </span>
                        </span>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="color-animation" style="animation-delay: {{$delay + 3}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 25}}s">
                                <span class="color-animation" style="animation-delay: {{$delay + 35}}s">
                                    -
                                </span>
                            </span>
                        </span>
                    ...
                    <h5 class="mt-2 ml-5">
                        <span class="drop-in" style="animation-delay: {{$delay + 38}}s">
                            {{$result_digit_1}}
                        </span>
                ...
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 40}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 41}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
