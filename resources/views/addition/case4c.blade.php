            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    ...
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay +1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 14}}s">{{$case_4_input_1_digit_1}}</span>
                        <span class="color-animation" style="animation-delay: {{$delay + 2}}s">{{$case_4_input_1_digit_2}}</span>
                    </h5>
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 16}}s">{{$case_4_input_2_digit_1}}</span>
                        <span class="color-animation" style="animation-delay: {{$delay + 4}}s">{{$case_4_input_2_digit_2}}</span>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="color-animation" style="animation-delay: {{$delay + 3}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 13}}s">
                    ...
                    <h5 class="mt-2 result-3-digit">
                        <span class="drop-in" style="animation-delay: {{$delay + 18}}s">{{$result_digit_1}}</span>
                        <span class="drop-in" style="animation-delay: {{$delay + 18}}s">{{$result_digit_2}}</span>
                        <span class="drop-in" style="animation-delay: {{$delay + 6}}s">{{$result_digit_3}}</span>
                    </h5>
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 19}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 20}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
