        ...
        <div class="p-5">
            ...
            <div class="bg-white border p-4">
                ...
                @php
                    $delay = 1;
                @endphp
                <p class="drop-in" style="animation-delay: {{$delay}}s" >Let's see this exponential table,</p>
                ...
                <p class="drop-in" style="animation-delay: {{$delay + 6}}s" >According to the table, we know that <b>{{ $input }}</b> is equal to <b>{{ $result }}</b> squared.</p>
                <p class="drop-in" style="animation-delay: {{$delay + 11}}s" >Therefore, we can also say that <b>{{ $input }}</b> is the product of <b>{{ $result }} x {{ $result }}</b>.</p>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 16}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 17}}s"><b>{{ $result }}</b></h5>
            </div>
        </div>
    </div>
    <!-- Content -->
