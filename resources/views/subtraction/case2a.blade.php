            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 2}}s">{{$case_2_input_1_digit_1}} {{$case_2_input_1_digit_2}}</span>
                    </h5>
                    ...
                    <h5 class="mt-2 result-1-digit">
                        <span class="drop-in" style="animation-delay: {{$delay + 6}}s">{{$result}}</span>
                    </h5>
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 7}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 8}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
