        ...
        <div class="p-5">
            ...
            <div class="bg-white border p-4">
                ...
                @php
                    ...
                    $delay = 1;
                @endphp
                <p class="drop-in" style="animation-delay: {{$delay}}s" >Let's multiply <b>{{$input_1}}</b> to itself 
                @if($input_2 == 1) by <b>{{$input_2}}</b>. @endif 
                @if($input_2 == 0 || $input_2 > 1) <b>{{$input_2}}</b> times. @endif</p>
                <div class="m-5">
                    <h5 class="drop-in" style="animation-delay: {{$delay + 1}}s">
                        @if($input_2 > 0)
                            <span class="drop-in" style="animation-delay: {{$delay + 2}}s">{{$input_1}}</span>
                        @endif
                        @php
                            $delay = 3;
                        @endphp
                        @for($i=2; $i <= $input_2; $i++)
                            ...
                            @endphp
                            <span class="drop-in" style="animation-delay: {{$delay}}s">x {{$input_1}}</span>
                        @endfor
                        @php
                            $delay += 1;
                        @endphp
                        <span class="drop-in" style="animation-delay: {{$delay}}s">= {{$result}}</span>
                    </h5>
                </div>
                @php
                    $delay += 1;
