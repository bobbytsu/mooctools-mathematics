...
<head>
    ...
    <title>Quiz 3rd & 4th Grade</title>
...
<body>
    ...
    <div class="container my-5 bg-light">
        <div class="p-5">
            ...
            <h4 class="text-center my-5">Quiz: 3<sup>rd</sup> & 4<sup>th</sup> Grade</h4>
            <h5 class="mb-5">Question</h5>
            <form method="POST" action="{{ route('quiz3rd4thgraderesult') }}" onsubmit="return confirm('Are you sure want to submit these answers?')">
                @csrf
                @php
                    $i = 1;
                @endphp
