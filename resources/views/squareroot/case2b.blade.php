            ...
            <div class="bg-white border p-4">
                ...
                <div class="my-5 mx-xl-5 mx-lg-5 mx-md-5 mx-sm-5 mx-xs-5 mx-0">
                    ...
                    <h5 class="squareroot-nearest-sqrt-1">
                        ...
                        <span class="drop-in" style="animation-delay: {{$delay + 74}}s">
                            .
                        </span>
                        <span class="drop-in" style="animation-delay: {{$delay + 75}}s">
                            {{$calculation4}}
                        </span>
                    ...
                    <h5 class="squareroot-calculation6 drop-in" style="animation-delay: {{$delay + 79}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 84}}s">
                            {{$calculation6}}
                        </span>
                        &nbsp;
                        <span class="drop-in" style="animation-delay: {{$delay + 81}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 83}}s">
                                -
                            </span>
                        </span>
                    </h5>
                    <hr class="drop-in squareroot-hr" style="animation-delay: {{$delay + 81}}s">
                    <h5 class="squareroot-calculation4-arrow drop-out" style="animation-delay: {{$delay + 67}}s">
                    ...
                    <h5 class="squareroot-calculation4-arrow-1 drop-in" style="animation-delay: {{$delay + 70}}s">
                        <span class="drop-out" style="animation-delay: {{$delay + 80}}s">
                            <span>→</span>
                            <span>
                                {{$calculation2}}
                            </span>
                            <span class="color-animation" style="margin-left: -5px; animation-delay: {{$delay + 72}}s">
                                .{{$calculation4}}
                            </span>
                            <span>x</span>
                            ...
                            <span class="color-animation" style="animation-delay: {{$delay + 77}}s">
                                {{$calculation6}}
                            </span>
                        </span>
                    </h5>
                    @for ($j = 0; $j < $count; $j++)
                        @if ($j < 2 || ($j === $count - 1 && $calculations[$j] <= $calculation1))
                            <h5 class="drop-in squareroot-calculation4-arrow-2" style="animation-delay: {{$delay + 60 + $k}}s">
                                <span class="drop-out" style="animation-delay: {{$delay + 67 + $k}}s">
                    ...
                    <h5 class="drop-in squareroot-case2b-calculation7" style="animation-delay: {{$delay + 23}}s">
                        {{$calculation7}}
                    </h5>                    
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 24}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 25}}s"><b>{{floor(sqrt($input) * 10) / 10}}</b></h5>
            </div>
        </div>
    </div>
    <!-- Content -->
