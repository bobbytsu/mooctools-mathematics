        ...
        <div class="p-5">
            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    ...
                    <h5 class="mt-2 ml-5">
                        <span class="drop-in" style="animation-delay: {{$delay + 36}}s">{{$result_digit_1}}</span>
                        <span class="drop-in" style="animation-delay: {{$delay + 28}}s">{{$result_digit_2}}</span>
                    </h5>
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 37}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 38}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
