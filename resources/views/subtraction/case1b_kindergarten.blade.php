    ...
    <div class="container my-5 bg-light">
        <div class="p-5">
            ...
            <div class="bg-white border p-4">
                <h5 class="mt-2 drop-in" style="animation-delay: 1s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: 2s"><b>{{$result}}</b></h5>
                <p class="mt-2 drop-in" style="animation-delay: 3s">It's a negative value! you will learn it in elementary grade.</p>
            </div>
            <!-- Solution -->
        </div>
    </div>
