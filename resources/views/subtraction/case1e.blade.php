        ...
        <div class="p-5">
            ...
            <div class="bg-white border p-4">
                ...
                <h5 class="drop-in ml-xl-5 ml-lg-5 ml-md-5 ml-sm-5 ml-xs-5 ml-0 mt-5" style="animation-delay: {{$delay + 1}}s">
                    ...
                    <span class="color-animation" style="animation-delay: {{$delay + 7}}s">- {{$input_2}}</span>
                </h5>
                <div class="mb-5 ml-xl-5 ml-lg-5 ml-0 text-xl-left text-lg-left text-center">
                    <h5 class="drop-in line-minus-2-input2" style="animation-delay: {{$delay + 9}}s">- {{$input_2}}</h5>
                    <img src="{{ asset('assets/line-minus-2.png') }}" alt="minus" class="drop-in line-minus-2" style="animation-delay: {{$delay + 10}}s">
                    ...
                    <h5 class="subtraction-case-1e-line-result-zero">
                        <span class="drop-in line-result" style="animation-delay: {{$delay + 12}}s">{{$result}}</span>
                        <span class="drop-in line-zero" style="animation-delay: {{$delay + 2}}s">
                            <span class="color-animation" style="animation-delay: {{$delay + 5}}s">
                                0
                            </span>
                        </span>
                    </h5>
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 13}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 14}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
