            ...
            <div class="bg-white border p-4">
                ...
                <div class="m-5">
                    ...
                    <h5 class="ml-5 drop-in" style="animation-delay: {{$delay + 1}}s">
                        <span class="color-animation" style="animation-delay: {{$delay + 14}}s">{{$case_2_input_1_digit_1}}</span>
                    ...
                    <h5 class="mt-2 ml-5">
                        <span class="drop-in" style="animation-delay: {{$delay + 16}}s">{{$result_digit_1}}</span>
                        <span class="drop-in" style="animation-delay: {{$delay + 6}}s">
                        {{$result_digit_2}}</span>
                    </h5>
                </div>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 17}}s">Result</h5>
                <h5 class="mt-2 drop-in" style="animation-delay: {{$delay + 18}}s"><b>{{$result}}</b></h5>
            </div>
            <!-- Solution -->
        </div>
    </div>
